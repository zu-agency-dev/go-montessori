...
(() => {
      ...
      if (startAt) {
        _removeFromParent(tween2._startAt = Tween.set(targets, _setDefaults({
          ...
          onUpdate: onUpdate && function() {
            return _callback(tween2, "onUpdate");
          },
          stagger: 0
        }, startAt)));
  ...
  var _updatePropTweens = function _updatePropTweens2(tween2, property, value, start, startIsRelative, ratio, time, skipRecursion) {
  ...
  var _gsap = {
    ...
    quickTo: function quickTo(target, property, vars) {
      var _setDefaults22;
      var tween2 = gsap.to(target, _setDefaults((_setDefaults22 = {}, _setDefaults22[property] = "+=0.1", _setDefaults22.paused = true, _setDefaults22.stagger = 0, _setDefaults22), vars || {})), func = function func2(value, start, startIsRelative) {
  ...
  var CSSPlugin = {
    ...
    init: function init3(target, vars, tween2, index, targets) {
      var props = this._props, style = target.style, startAt = tween2.vars.startAt, startValue, endValue, endNum, startNum, type, specialProp, p, startUnit, endUnit, relative, isTransformRelated, transformPropTween, cache, smooth, hasPriority, inlineProps, finalTransformValue;
      _pluginInitted || _initCore();
  ...
  // node_modules/.pnpm/gsap@3.14.2/node_modules/gsap/ScrollToPlugin.js
  var gsap2;
  var _coreInitted2;
  var _window;
  var _docEl;
  ...
  var _getBounds = function _getBounds2(element, withoutTransforms) {
    var tween2 = withoutTransforms && _getComputedStyle(element)[_transformProp2] !== "matrix(1, 0, 0, 1, 0, 0)" && gsap4.to(element, {
      x: 0,
      y: 0,
      xPercent: 0,
      yPercent: 0,
  ...
  var _getTweenCreator = function _getTweenCreator2(scroller, direction) {
    var getScroll = _getScrollFunc(scroller, direction), prop = "_scroll" + direction.p2, getTween = function getTween2(scrollTo, vars, initialValue, change1, change2) {
      ...
      tween2 = getTween2.tween = gsap4.to(scroller, vars);
      return tween2;
    };
  ...
  // src/scripts/section-pages.ts
  gsapWithCSS.registerPlugin(ScrollToPlugin, ScrollTrigger3);
  var SELECTORS = {
  ...
  var SCROLL_SPEED_MULTIPLIER = 0.5;
  var panelsContainer = document.querySelector(SELECTORS.PANEL_CONTAINER);
  var paddingGlobal = document.querySelector(SELECTORS.PADDING_GLOBAL);
  var panels = gsapWithCSS.utils.toArray(SELECTORS.PANEL_ITEM);
  var tween = gsapWithCSS.to(panelsContainer, {
    x: () => -(panelsContainer.scrollWidth - document.documentElement.clientWidth + panelsContainer.getBoundingClientRect().left + (paddingGlobal ? parseFloat(getComputedStyle(paddingGlobal).paddingRight) : 0)),
    ease: "none",
    scrollTrigger: {
...
gsap/ScrollTrigger.js:
  ...
  *)
*/
//# sourceMappingURL=section-pages.js.map
